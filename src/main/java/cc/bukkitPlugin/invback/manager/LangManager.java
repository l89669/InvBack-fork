...
public class LangManager extends TLangManager<InvBack>{
    ...
    public void addDefaults(){
        ...
        this.mConfig.addDefault("MsgErrorOnModelBackupCopyFile","模块 %modle% 在备份数据复制文件时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelBackupFile","模块 %modle% 在备份数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelCopyPlayerData","模块 %modle% 在复制玩家 %player% 的数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelLoadPlayerDataFromFile","模块 %modle% 在从文件还原玩家 %player% 的数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelLoadPlayerDataFromMemory","模块 %modle% 在从内存还原玩家 %player% 的数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelResetPlayerData","模块 %modle% 在重置 %player% 的数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelRestoreData","模块 %modle% 在还原数据时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelSavePlayerDataToFile","模块 %modle% 在保存玩家 %player% 的数据到文件时发生了错误");
        this.mConfig.addDefault("MsgErrorOnModelSavePlayerDataToMemory","模块 %modle% 在保存玩家 %player% 的数据到内存时发生了错误");
